  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <nav className={`fixed-header ${isScrolled ? 'scrolled' : ''}`}>
        <div className="">
          <h1 className="textPad font-bold [text-shadow:_3px_3px_0_rgba(0,0,0,0.4)]">Detetive de Objetos</h1>
        </div>
      </nav>
              ...
              {detectionResult ? (
                <div>
                  ...
                  {currentMissionIndex < missionsList.length - 1 ? (
                    ...
                    <p className="text-xl font-bold [text-shadow:_2px_2px_0_rgba(0,0,0,0.3)] text-[#3B2A1D]">Missões concluídas!</p>
                  )}
                </div>
              ) : (
                <div>
